...
using Chocopoi.DressingFramework.Extensibility.Event;
...
namespace Chocopoi.DressingFramework.Tests.Extensibility
{
    public class PluginManagerTest : EditorTestBase
    {
        ...
        {
            public override string FriendlyName => "Test hook";
        ...
        private class TestPluginManagerPlugin : Plugin
        {
            ...
            {
                RegisterBuildPass(new TestHook());
        ...
        [Test]
        public void HooksAtStageTest()
        {
            AssertHasType(new PluginManager().GetBuildPassesAtStage(BuildStage.Generation), typeof(TestHook));
        }

        [Test]
        public void GetAllFrameworkEventHandlers()
        {
            AssertHasType(new PluginManager().GetAllFrameworkEventHandlers(), typeof(TestFrameworkEventHandler));
        }
    }
}
