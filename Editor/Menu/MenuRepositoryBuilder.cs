...
namespace Chocopoi.DressingFramework.Menu
{
    public class MenuRepositoryBuilder
    {
        ...
        public MenuRepositoryBuilder AddButton(string name, MenuItem.ItemController controller, Texture2D icon = null)
        {
        ...
        public MenuRepositoryBuilder AddButton(string name, string animatorParameter, float animatorParameterValue, Texture2D icon = null)
        {
            _menu.Add(new MenuItem()
            {
                ...
                controller = new MenuItem.ItemController()
                {
                    ...
                    animatorParameterName = animatorParameter,
                    animatorParameterValue = animatorParameterValue
                }
            });
            return this;
        }

        public MenuRepositoryBuilder AddToggle(string name, MenuItem.ItemController controller, Texture2D icon = null)
        {
            _menu.Add(new MenuItem()
            {
                name = name,
