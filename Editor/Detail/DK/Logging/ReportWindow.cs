...
namespace Chocopoi.DressingFramework.Detail.DK.Logging
{
    ...
    public class ReportWindow : EditorWindow
    {
        ...
        internal static readonly Dictionary<string, DKReport> Reports = new Dictionary<string, DKReport>();
        ...
        internal static void AddReport(string reportName, DKReport report)
        {
            Reports.Add($"{reportName} ({DateTime.Now:yyyy-MM-dd HH:mm:ss.fff})", report);
        }
