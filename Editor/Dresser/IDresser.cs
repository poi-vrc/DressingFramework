...
namespace Chocopoi.DressingFramework.Dresser
{
    /// <summary>
    /// Dresser interface
    /// </summary>
    public interface IDresser
    {
        ...
        DKReport Execute(DresserSettings settings, out List<ArmatureMappingWearableModuleConfig.BoneMapping> boneMappings);
    }
}
