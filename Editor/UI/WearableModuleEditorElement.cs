...
{
    /// <summary>
    /// Wearable module editor base class for Unity UIElement
    /// </summary>
    public abstract class WearableModuleEditorElement : ElementViewBase, IWearableModuleEditor
    {
        /// <summary>
        ...
        public WearableModuleEditorElement(IWearableModuleEditorViewParent parentView, WearableModuleProviderBase provider, IModuleConfig target)
        {
